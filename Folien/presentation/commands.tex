...
\newcommand{\oHNN}{\op{H}_{\mathrm{NN}}}
\newcommand{\oHTB}{\op{H}_{\mathrm{TB}}}
\newcommand{\oHWW}{\op{H}_{\mathrm{WW}}}
\newcommand{\oHWWeff}{\op{H}_{\mathrm{WW}}^{(\mathrm{eff})}}
...
\def\ob#1{\op{B}^{\pdagg}_{#1}}
\def\obd#1{\op{B}^{\dagg}_{#1}}
...
\newcommand{\mone}{\mb{1}}
\newcommand{\mhpp}{\mb{h}''}
\newcommand{\mBp}{\mb{B}_+}
\newcommand{\mBm}{\mb{B}_-}
\newcommand{\mBpm}{\mb{B}_\pm}
\newcommand{\mUp}{\mb{U}_+}
\newcommand{\mUm}{\mb{U}_-}
\newcommand{\mUpm}{\mb{U}_\pm}
\newcommand{\mU}{\mb{U}}
...
% Custom to Superconductivity
\newcommand{\ocdu}{\ocd{\vk', \uparrow}}
\newcommand{\ocdd}{\ocd{-\vk',\downarrow}}
\newcommand{\ocndd}{\oc{-\vk, \downarrow}}
\newcommand{\ocndu}{\oc{\vk, \uparrow}}
\newcommand{\ocdup}{\ocd{\vk, \up}}
\newcommand{\ocddown}{\ocd{-\vk, \down}}
\newcommand{\ocup}{\oc{\vk, \up}}
\newcommand{\ocdown}{\oc{-\vk, \down}}
\newcommand{\oadup}{\oad{\vk, \up}}
\newcommand{\oaddown}{\oad{-\vk, \down}}
\newcommand{\oaup}{\oa{\vk, \up}}
\newcommand{\oadown}{\oa{-\vk, \down}}
\newcommand{\obdup}{\obd{\vk, \up}}
\newcommand{\obddown}{\obd{-\vk, \down}}
\newcommand{\obup}{\ob{\vk, \up}}
\newcommand{\obdown}{\ob{-\vk, \down}}

% Nambu Spinors
\newcommand{\opsi}{\symbf{\Psi}^{\pdagg}}
\newcommand{\opsid}{\symbf{\Psi}^{\dagg}}
\newcommand{\vopsi}{\vec{\symbf{\Psi}}^{\pdagg}}
\newcommand{\vopsid}{\vec{\symbf{\Psi}}^{\dagg}}
\newcommand{\ophi}{\symbf{\varphi}^{\pdagg}}
\newcommand{\ophid}{\symbf{\varphi}^{\dagg}}
\newcommand{\vophi}{\vec{\symbf{\varphi}}^{\pdagg}}
\newcommand{\vophid}{\vec{\symbf{\varphi}}^{\dagg}}

% For Hopping terms
\newcommand{\oakd}{\oad{\vk, \sigma}}
\newcommand{\oak}{\oa{\vk, \sigma}}
\newcommand{\obkd}{\obd{\vk, \sigma}}
\newcommand{\obk}{\ob{\vk, \sigma}}
\newcommand{\ockd}{\ocd{\vk, \sigma}}
\newcommand{\ock}{\oc{\vk, \sigma}}
% For Hubbard Terms
% \newcommand{\ocdur}{\ocd{\vk+\mb{q}, \uparrow}}
% \newcommand{\ocddr}{\ocd{\mb{k'} - \mb{q},\downarrow}}
% \newcommand{\ocnddr}{\oc{\mb{k'}, \downarrow}}
% \newcommand{\ocndur}{\oc{\vk, \uparrow}}

% For Fermionic and bosonic Operators
\def\ofe#1{\op{c}^{\pdagg}_{#1}}
\def\ofed#1{\op{c}^{\dagg}_{#1}}
\def\obo#1{\op{b}^{\pdagg}_{#1}}
\def\obod#1{\op{b}^{\dagg}_{#1}}
...
% Restricted Sum
\def\sump#1{\sideset{}{'}\sum_{#1}}
% \def\sump#1{\sum_{#1}'}
% \def\sump#1{\sum_{#1}^{\prime}
% \newcommand{\sumpk}{\sideset{}{'}\sum_{\vec{k}}}
% \newcommand{\sumpk}{\sum_{\vec{k}}'}




\newcommand{\ophioned}{\symbf{\varphi}^{\dagg}_{1, \vk}}
\newcommand{\ophione}{\symbf{\varphi}^{\pdagg}_{1, \vk}}
\newcommand{\ophitwod}{\symbf{\varphi}^{\dagg}_{2, \vk}}
\newcommand{\ophitwo}{\symbf{\varphi}^{\pdagg}_{2, \vk}}
\newcommand{\ophithreed}{\symbf{\varphi}^{\dagg}_{3, \vk}}
\newcommand{\ophithree}{\symbf{\varphi}^{\pdagg}_{3, \vk}}
\newcommand{\ophifourd}{\symbf{\varphi}^{\dagg}_{4, \vk}}
\newcommand{\ophifour}{\symbf{\varphi}^{\pdagg}_{4, \vk}}
...
\def\tuorange#1{{\color{tuorange}{#1}}}
\def\tublue#1{{\color{tublue}{#1}}}
