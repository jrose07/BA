...
Regt ein Leitungselektron eine Gitterschwingung an bewegt es sich in der Zeit, in der die ausgelenkten Atomrümpfe zurückschwingen um mehrere Gitterkonstanten weiter, während es am Auslenkungsort eine positive Polarisierungsblase hinterlässt die selbst weitere Elektronen anzieht. 
...
Für größere Energieunterschiede wirkt die Wechselwirkung hingegen abstoßend und ist außerdem für $\Delta \epsilon = \hbar \omega_\vq$ singulär. 
Da allerdings aufgrund des Pauli-Verbots davon ausgegangen werden kann, dass die gestreuten Elektronen vor allem aus der Nähe der Fermi-Energie stammen und damit hauptsächlich Beiträge mit kleinen Energiedifferenzen $\Delta \epsilon < \hbar \omega_\vq$ wichtig sind, kann der repulsive Teil der Wechselwirkung mit $\Delta \epsilon \geq \hbar \omega_\vq$ vernachlässigt werden~\cite{bardeen_theory_1957}.
Es wird also formell der Cutoff $\abs{\Delta \epsilon} < \hbar \omega_\vq < \hbar \omega_D$ mit der Debye-Frequenz $\omega_D$ eingeführt, innerhalb der die Wechselwirkung rein anziehend ist.

Alternativerweise ist es ebenfalls möglich eine rein attraktive Wechselwirkung ohne Singularitäten direkt über andere kontinuierliche Trafos zu erhalten (siehe Ref.~\cite{krull_enhanced_2012}). 
...
Es entsteht also eine effektive phononübermittelnde Anziehung, die in dem Energiefenster
\begin{align}
    E_F - \hbar \omega_D \leq \epsilon_\vk \leq E_F + \hbar \omega_D
\end{align}
um die Fermienergie herum für die Ausbildung von Cooper-Paaren sorgt\footnote{Diese Bedingung ergibt sich aus der Cutoff-Bedingung $\abs{\Delta \epsilon} = \abs{\epsilon_\vk - \epsilon_{\vk'}} < \hbar \omega_D$, für die Vereinfachung, dass $\epsilon_{\vk'} = E_F$ ist. Dies ist auch vernünftig, da die gestreuten Elektronen ja aus der Nähe der Fermikante kommen sollen.}.
