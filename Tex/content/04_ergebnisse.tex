...
% Abseits dieser groben Abschätzung liefern Herrera et al.\ ~\cite{herrera_topological_2024} konkrete .
...
% % Neben dieser Abschätzung kann außerdem ein direkter Vergleich mit experimentell gemessenen Werten erfolgen.
% Neben dieser groben Abschätzungen können für Graphen aber auch anhand von experimentell gemessenen Daten 
...
Es ist zu erkennen, dass an der VHS bei Kopplungen in der für konventionelle Supraleiter typischen Größenordnung von ca. $\qty{1}{eV}$ verhältnismäßig große kritische Temperaturen auftreten, während dies bei halber Füllung erst ab einer kritischen Kopplung von $U_C \approx \qty{198}{eV}$ der Fall ist, was deutlich über dem realistischen Bereich von $U$ liegt.
...
Der bereits erwähnte Vergleich zu Ref.~\cite{herrera_topological_2024} zeigt, dass die vorhergesagte kritische Temperatur $T_C = \qty{600}{\milli\kelvin}$ für $U$ in dem Bereich $\num{0.5} - \qty{1.1}{eV}$ reproduziert wird, was eine vergleichbare Größenordnung wie die abgeschätzte Kopplungsstärke in Niob aufweist. 
% Im Rahmen dieser ungefähren Abschätzung wäre 
Es ist anhand dieser Abschätzung also nicht auszuschließen, dass (stark) dotiertes Graphen konventionelle Supraleitung zeigen kann.

% Außerdem scheint und die Dotierung bis zur VHS unter der Annahme starrer Bänder 
