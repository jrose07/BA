...
Dabei werden die allgemeinen fermionischen Operatoren $\ofe{}$  durch die Untergitter-spezifischen Operatoren $\oa{}$ bzw.\ $\ob{}$ ersetzt, die nur Elektronen auf dem jeweiligen Untergitter $A$ oder $B$ erzeugen, bzw.~vernichten. 
...
Im Folgenden wird diese allerdings weggelassen, da für die Normalordnung von bilinearen Termen $: \op{c}\op{c}: = \op{c}\op{c} - \expval{\op{c} \op{c}} $ gilt~\cite{kehrein_flow_2006} und $\expval{\op{c} \op{c}}$ einfach in die Konstante absorbiert werden kann.
