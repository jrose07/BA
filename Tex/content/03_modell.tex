...
Er enthält die anomale Erwartungswerte $\expval{\ocdu \ocdd}$ bzw. $\expval{\ocndd \ocndu}$, also Erwartungswerte der Paarerzeugung(-vernichtung) von Cooper-Paaren mit dem in Abbildung~\ref{fig:s_wave} begründeten Gesamtimpuls $\vec{K} = 0$. 
